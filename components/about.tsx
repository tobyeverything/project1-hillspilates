      ...
      <div className="relative z-10 px-6 py-20 md:px-10 md:py-28 lg:px-16 lg:py-32">
        <div ref={headerRef} className="max-w-2xl">
          ...
          <p className="about-header-item mt-6 text-base leading-relaxed text-muted-foreground opacity-0 md:text-lg">
            Hills Pilates was founded on the belief that movement should be
            intentional, accessible, and transformative. Our studio is a space
            where discipline meets flow — designed for anyone ready to invest in
            how their body feels, not just how it looks.
          </p>
        </div>
